...
function s:filetype ()
  ...
  elseif match (s:file, "\.py$") != -1
    let s:comment = "#"
    "let s:type = s:comment . "!" . system ("whereis -b python2 | awk '{print $2}' | tr -d '\n'")
    let s:type = s:comment . "!" . "/usr/bin/python2"
